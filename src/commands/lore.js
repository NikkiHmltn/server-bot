    ...
    execute(message, args) {
        if (!args[0] || args[0] === "") {
            ...
            const embeded = new Discord.MessageEmbed()
                ...
                .setDescription("Farmer Kirari is CastleofLion's crack headcanon about the origin of the Momobami name. I think the Kaichou looks pretty next to the peach blossoms. <:kirarifarmerchibi:792942644607057950> *Beep Boop*\nhttps://discord.com/channels/710204822846046258/710204823433379985/716347441485709432")
