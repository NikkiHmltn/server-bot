module.exports = {
    ...
    execute(message, args){
        if (!args[0] || args[0] === "") {
            ...
            message.channel.send(`If you would like to read the full list of rules, please see the admin's post here: https://discord.com/channels/710204822846046258/739851594069180508/739853061970722887`)
        }
    }
}